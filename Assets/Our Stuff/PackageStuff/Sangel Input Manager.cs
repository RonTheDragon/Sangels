...
//     version 1.4.4
//     from Assets/Our Stuff/PackageStuff/Sangel Input Manager.inputactions
//
...
{
    public partial class @SangelInputManager : IInputActionCollection2, IDisposable
    {
        public InputActionAsset asset { get; }
        public @SangelInputManager()
        {
            asset = InputActionAsset.FromJson(@"{
    ""name"": ""Sangel Input Manager"",
    ""maps"": [
        {
            ""name"": ""Sangel"",
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Eat"",
                    ""type"": ""Button"",
                    ""id"": ""05980253-00f1-4e5d-900b-417b0b98bb21"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""ea276514-6d0e-4cee-b767-a576f5fc60de"",
                    ""path"": ""<Keyboard>/f"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""a5b84f45-45e1-4571-9f83-050ce0280dbf"",
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            m_Sangel_Eat = m_Sangel.FindAction("Eat", throwIfNotFound: true);
        ...
        private readonly InputAction m_Sangel_Eat;
        ...
        public struct SangelActions
        {
            ...
            public SangelActions(@SangelInputManager wrapper) { m_Wrapper = wrapper; }
            ...
            public InputAction @Eat => m_Wrapper.m_Sangel_Eat;
            ...
            public void SetCallbacks(ISangelActions instance)
            {
                if (m_Wrapper.m_SangelActionsCallbackInterface != null)
                {
                    ...
                    @Eat.started -= m_Wrapper.m_SangelActionsCallbackInterface.OnEat;
                    @Eat.performed -= m_Wrapper.m_SangelActionsCallbackInterface.OnEat;
                    @Eat.canceled -= m_Wrapper.m_SangelActionsCallbackInterface.OnEat;
        ...
        {
            private @SangelInputManager m_Wrapper;
            public UIActions(@SangelInputManager wrapper) { m_Wrapper = wrapper; }
